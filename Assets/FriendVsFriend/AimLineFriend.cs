...
public class AimLineFriend : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!IsShooting 
            ...
            && ((_networkManager.levelDef.IsPlayerLeftTurn && _networkManager.CurrentUser.UserId == _networkManager.levelDef.PlayerLeftId)
                || (!_networkManager.levelDef.IsPlayerLeftTurn && _networkManager.CurrentUser.UserId == _networkManager.levelDef.PlayerRightId))
            )
        {
